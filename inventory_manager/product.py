...
# Date: 20/03/2026
# product.py
# Description: This module contains the Product class which represents individual 
# inventory items with validation and stock management.


class Product:

    """
    A class to represent a single product in the inventory system.
    ...
    def __init__(self, product_id, name, category, price, quantity, min_stock):
       """Initialises a new Product instance with validated attributes."""
    ...
    def get_value(self):
        """Returns the total monetary value of the current stock (price * quantity)."""
        return self.price * self.quantity
    
    def is_low_stock(self):
        """Returns True if the current quantity is at or below the min_stock level."""
        if self.quantity <= self.min_stock:
            return True
        return False
    
    def to_dict(self):
        """Returns a dictionary representation of the product for JSON storage."""
    ...
    def from_dict(cls, product_id, data):
        """
        Class method to create a new Product object from a dictionary.
        ...
        Returns:
            Product: A new instance of the Product class.
        """
        name = data.get('Name')
    ...
    def __str__(self):
        """Returns a readable string representation of the product's details."""
